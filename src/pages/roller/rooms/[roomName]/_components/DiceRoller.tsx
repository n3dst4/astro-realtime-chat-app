  ...
  return (
    <div className="flex h-full w-full flex-col">
      ...
      <form onSubmit={handleSubmit} className="flex flex-row flex-wrap p-4">
        <div className="border-primary flex min-w-0 flex-1 flex-col overflow-hidden rounded-l-xl border shadow-sm sm:flex-row">
          <input
            className="bg-base-100 border-base-300 placeholder:text-base-content/40 min-w-0 flex-1 border-b px-4 py-2 outline-none sm:border-r sm:border-b-0"
            value={formula}
