/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/worker-configuration.d.ts` (hash: abeec1ec421ecfb1cb37f3a25916d41f)
// Runtime types generated with workerd@1.20260128.0 2025-12-04 disable_nodejs_process_v2,global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
  interface GlobalProps {
    mainModule: typeof import("./workers/worker");
    durableNamespaces: "ChatRoom" | "Counter";
  }
  interface Env {
    todos: D1Database;
    ASSETS: Fetcher;
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<
    Pick<Cloudflare.Env, "PUBLIC_CLERK_PUBLISHABLE_KEY" | "CLERK_SECRET_KEY">
  > {}
}
