/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/worker-configuration.d.ts` (hash: a0814e2c035ec3332bc732a443d2f674)
// Runtime types generated with workerd@1.20260302.0 2025-12-04 disable_nodejs_process_v2,global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./workers/worker");
		durableNamespaces: "DiceRollerRoom";
	}
	interface StagingEnv {
		...
		DiceRollerRoom: DurableObjectNamespace<import("./workers/worker").DiceRollerRoom>;
	}
	interface Env {
		D1_TOKEN: string;
		CLOUDFLARE_ACCOUNT_ID: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "D1_TOKEN" | "CLOUDFLARE_ACCOUNT_ID">> {}
}
